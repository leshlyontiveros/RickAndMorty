import { FETCH_EPISODES, FETCH_PERSONAGENS_START, FETCH_PERSONAGENS_SUCCESS, FETCH_PERSONAGEM_ID_SUCCESS, FETCH_PERSONAGENS_ERROR, FAVORITAR_PERSONAGENS } from '../actions/characters';
import { Info, Personagem, ActionType } from '../../types';
